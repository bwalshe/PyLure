...
few weeks ago while tryong to get over a chest infection. It's an OK game,
but the path-finding in the SCUMVM implementation seems a bit off, and I 
...
game. This info is extracted from the `lure.dat` file which is available on the
SCUMVM repo [here](https://github.com/scummvm/scummvm/tree/master/dists/engine-data)
